        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Welcome back, {session?.user?.parent?.name}</p>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Children's Leave Applications</h2>
              </div>
              <div className="p-6">
                {leaveApplications.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Your children haven't submitted any leave applications yet.</p>
                  </div>
                ) : (
                      ...
                      <div key={application.id} className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="mb-4">
                          ...
                          {application.facultyComments && (
                            <p className="text-sm text-gray-600 mt-1">
                              <strong>Faculty Comments:</strong> {application.facultyComments}
                            </p>
                          )}
                        </div>
                          ...
                          <div className="flex space-x-2">
                            <button
                              onClick={() => {
                                ...
                                if (comments !== null) {
                                  handleAction(application.id, 'PARENT_APPROVE', comments)
                                }
                              }}
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (comments) {
                                  handleAction(application.id, 'PARENT_REJECT', comments)
                                }
                              }}
